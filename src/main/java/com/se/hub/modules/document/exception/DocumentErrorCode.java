...
public enum DocumentErrorCode {
    ...
    DOCUMENT_FILE_TOO_LARGE(MessageCodeConstant.E001_VALIDATION_ERROR, DocumentMessageConstants.DOCUMENT_FILE_TOO_LARGE_MESSAGE, HttpStatus.BAD_REQUEST),
    ...
    DOCUMENT_IMAGE_TOO_LARGE(MessageCodeConstant.E001_VALIDATION_ERROR, DocumentMessageConstants.DOCUMENT_IMAGE_TOO_LARGE_MESSAGE, HttpStatus.BAD_REQUEST),
    ...
    public ErrorCode toErrorCode() {
        return switch (this) {
            ...
            case DOCUMENT_NAME_INVALID, DOCUMENT_DESCRIPT_INVALID, DOCUMENT_SEMESTER_INVALID,
                 ...
                 DOCUMENT_IMAGE_INVALID_FORMAT, DOCUMENT_FILE_TOO_LARGE, DOCUMENT_IMAGE_TOO_LARGE,
                 DOCUMENT_UNAPPROVED -> ErrorCode.DATA_INVALID;
